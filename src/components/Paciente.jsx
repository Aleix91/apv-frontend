...
const Paciente = ({paciente}) => {
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <p className="font-bold uppercase text-indigo-700 my-2">Email de Contacto: <span className="font-normal normal-case text-black">{email}</span></p>
        ...
        <p className="font-bold uppercase text-indigo-700 my-2">Síntomas: <span className="font-normal normal-case text-black">{sintomas}</span></p>
